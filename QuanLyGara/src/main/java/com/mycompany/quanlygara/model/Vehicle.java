...
public class Vehicle {
    ...
    // Khởi tạo đối tượng Vehicle mới
    public Vehicle(String licensePlate, String brand, String model, int productionYear, Customer Customer, String color,
            String condition) {
    ...
    public static String getMilitaryUnit(String prefix) {
        switch (prefix) {
            ...
            case "AX":
                return "Binh đoàn 16";
            case "BB":
                return "Binh chủng Tăng Thiết giáp";
            case "BC":
                return "Binh chủng Công binh";
            case "BH":
                return "Binh chủng Hóa học";
            case "BK":
                return "Binh chủng Đặc công";
            case "BP":
                return "Binh chủng Pháo binh";
            case "BS":
                return "Binh chủng Thông tin";
            case "BT":
                return "Binh chủng Thông tin liên lạc";
            case "HA":
                return "Học viện Lục quân";
            case "HB":
                return "Học viện Quốc phòng";
            case "HC":
                return "Học viện Quân y";
            case "HD":
                return "Học viện Kỹ thuật Quân sự";
            case "HE":
                return "Học viện Hậu cần";
            case "HT":
                return "Trường Sĩ quan Lục quân 1";
            case "HQ":
                return "Hải quân";
            case "KA":
                return "Quân đoàn 1";
            ...
            case "KD":
                return "Quân đoàn 4";
            case "KK":
                return "Tổng cục Kỹ thuật";
            case "KP":
                return "Tổng cục Hậu cần";
            case "KV":
                return "Tổng cục Công nghiệp Quốc phòng";
            case "PA":
                return "Cục Đối ngoại Bộ Quốc phòng";
            case "PP":
                return "Bộ Tổng Tham mưu";
            case "PX":
                return "Tổng cục Chính trị";
            case "QA":
                return "Quân chủng Phòng không - Không quân";
            case "QB":
                return "Bộ Tư lệnh Biên phòng";
            case "QC":
                return "Bộ Tư lệnh Cảnh sát biển";
            case "QD":
                return "Bộ Tư lệnh Thủ đô Hà Nội";
            case "QH":
                return "Tổng cục Tình báo Quốc phòng";
            case "TC":
                return "Tổng cục Công nghiệp Quốc phòng";
            case "TH":
                return "Tổng cục Hậu cần";
            ...
            case "VT":
                return "Viettel";
            default:
                return "Đơn vị Quân đội nhân dân Việt Nam";
        }
    }
    ...
    public void nhapInfo(Scanner sc) {
        ...
        while (true) {
            ...
            String inputPlate = com.mycompany.quanlygara.util.StringUtils.removeAccents(sc.nextLine().trim())
                    .toUpperCase();
            ...
            if (plateTypeChoice.equals("2")) {
                // Military plate constraint: must start with 2 uppercase letters followed by
                // digits
    ...
    public String toString() {
        return "Vehicle [License Plate: " + licensePlate + ", Brand: " + brand + ", Model: " + model
