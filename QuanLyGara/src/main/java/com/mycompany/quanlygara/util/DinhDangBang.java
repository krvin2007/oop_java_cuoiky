...
public class DinhDangBang {

    public static void printCustomers(List<ChuXe> list) {
    ...
    public static void printVehicles(List<Xe> list) {
        if (list == null || list.isEmpty()) {
            System.out.println("Danh sach trong.");
            return;
        }
    ...
    public static void printMechanics(List<KyThuatVien> list) {
        if (list == null || list.isEmpty()) {
            System.out.println("Danh sach trong.");
            return;
        }
    ...
    public static void printRepairOrders(List<PhieuSuaChua> list) {
        if (list == null || list.isEmpty()) {
            System.out.println("Danh sach trong.");
            return;
        }
    ...
    public static void printInvoices(List<HoaDon> list) {
        if (list == null || list.isEmpty()) {
            System.out.println("Danh sach trong.");
            return;
        }
